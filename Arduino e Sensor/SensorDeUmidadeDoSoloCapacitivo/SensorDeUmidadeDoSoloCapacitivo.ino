...
void loop() { // Repetição do código
 ...
 // Invertendo as métricas do sensor para captar a porcentagem de Umidade
  ...
  // Umidade Máxima
  Serial.print("UmidadeMáxima:"); // Label de Umidade Máxima
  Serial.print(40); // Valor da Umidade Máxima
  Serial.print(" "); // Intervalo para inserção de outro valor
  
  // Umidade
  Serial.print("Umidade:"); // Label de valor da Umidade
  Serial.print(umidade - 20); // Valor medido pelo sensor - 20 para se adequar as condições do projeto
  Serial.print(" "); // Intervalo para inserção de outro valor

  // Umidade Mínima
  Serial.print("UmidadeMínima:"); // Label para Umidade Mínima
  Serial.println(20); // Valor da Umidade Mínima
